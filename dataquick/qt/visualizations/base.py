...
class Visualization(QtWidgets.QWidget):
    ...
    Very minimal skeleton defining the expected behavior a QWidget used to visualize a DataQuickFrame.  Almost
    ...
    supported_classes : list of Type(DataQuickFrame)
        *cls var*, provide an easy mechanism to validate if the DataQuickFrame objects in the visualization
